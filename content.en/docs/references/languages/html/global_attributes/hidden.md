...
::: section-content
The `hidden` [global attribute](../global_attributes) is an
...
#### HTML Demo: hidden {#html-demo-hidden .output-heading}
...
``` {signature="F6QSeMMmMzhH/YQwuFZG+tGfuv+WJ96PBn5zxBy93zg=" data-language="html"}
...
``` {signature="arjxHMT0xZ28pDKZEfA6hIwFAX5UgUgITFKUufM7IQQ=" data-language="html"}
...
### The hidden state {#the_hidden_state}
...
### The hidden until found state {#the_hidden_until_found_state}
...
Also, the element needs to be affected by [layout
...
### Using until-found {#using_until-found}

::: section-content
In this example we have:

-   Three [``](../element/div) elements. The first and the third
...
``` {signature="Nm2LZ7wqgBvDiABN7iDpXhwSzmpuHx+2TEPF5NlSgKU=" data-language="html"}
...
``` {signature="QUGQfj/+IUu+NKbU0+1TXJuDk9Iae8xvJjdYm/RH7hs=" data-language="css"}
div {
  height: 40px;
  width: 300px;
...
``` {signature="b8swrc4z2/GmaZzeCCtA+4mjq1wx9NfpkCElqlqR/9w=" data-language="js"}
...
or later.\
[https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/hidden](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/hidden){._attribution-link}
:::
