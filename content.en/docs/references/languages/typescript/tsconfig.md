...
#### `System` {#system style="position:relative;"}
...
#### `node16`/`nodenext` (nightly builds) {#node16nodenext-nightly-builds style="position:relative;"}
...
#### References to `const enum` members {#references-to-const-enum-members style="position:relative;"}
...
::: section
### Charset - `charset` {#charset-config}
...
::: section
### Keyof Strings Only - `keyofStringsOnly` {#keyofStringsOnly-config}
...
::: section
### No Implicit Use Strict - `noImplicitUseStrict` {#noImplicitUseStrict-config}
...
::: section
### No Strict Generic Checks - `noStrictGenericChecks` {#noStrictGenericChecks-config}
...
-   Released:
    ...
    [2.4](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-2-4.html){aria-label="Release notes for TypeScript 2.4"}
...
::: section
### Suppress Excess Property Errors - `suppressExcessPropertyErrors` {#suppressExcessPropertyErrors-config}
...
::: section
### Suppress Implicit Any Index Errors - `suppressImplicitAnyIndexErrors` {#suppressImplicitAnyIndexErrors-config}
...
::: section
### Emit Decorator Metadata - `emitDecoratorMetadata` {#emitDecoratorMetadata-config}
...
-   Related:
    -   [`experimentalDecorators`](#experimentalDecorators){aria-label="Jump to compiler option info for experimentalDecorators"}

</div>
:::

::: section
### Experimental Decorators - `experimentalDecorators` {#experimentalDecorators-config}
...
-   Related:
    -   [`emitDecoratorMetadata`](#emitDecoratorMetadata){aria-label="Jump to compiler option info for emitDecoratorMetadata"}
...
### For example {#for-example style="position:relative;"}
...
-   Related:
    -   [`jsxFactory`](#jsxFactory){aria-label="Jump to compiler option info for jsxFactory"}

    -   [`jsxFragmentFactory`](#jsxFragmentFactory){aria-label="Jump to compiler option info for jsxFragmentFactory"}

    -   [`jsxImportSource`](#jsxImportSource){aria-label="Jump to compiler option info for jsxImportSource"}

-   Released:

    [2.2](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-2-2.html){aria-label="Release notes for TypeScript 2.2"}

</div>
:::

::: section
### JSX Factory - `jsxFactory` {#jsxFactory-config}
...
-   Related:
    -   [`jsx`](#jsx){aria-label="Jump to compiler option info for jsx"}
...
::: section
### JSX Fragment Factory - `jsxFragmentFactory` {#jsxFragmentFactory-config}
...
-   Released:
    ...
    [4.0](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-4-0.html){aria-label="Release notes for TypeScript 4.0"}

</div>
:::

::: section
### JSX Import Source - `jsxImportSource` {#jsxImportSource-config}
...
### High Level libraries {#high-level-libraries style="position:relative;"}
...
### Individual library components {#individual-library-components style="position:relative;"}
...
-   Related:
    -   [`noLib`](#noLib){aria-label="Jump to compiler option info for noLib"}
...
::: section
### Module Detection - `moduleDetection` {#moduleDetection-config}
...
-   Related:
    -   [`lib`](#lib){aria-label="Jump to compiler option info for lib"}

</div>
:::

::: section
### React Namespace - `reactNamespace` {#reactNamespace-config}
...
::: section
### Use Define For Class Fields - `useDefineForClassFields` {#useDefineForClassFields-config}
...
-   Released:
    ...
    [3.7](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-3-7.html){aria-label="Release notes for TypeScript 3.7"}
...
-   Deprecated
-   Related:
    -   [`extendedDiagnostics`](#extendedDiagnostics){aria-label="Jump to compiler option info for extendedDiagnostics"}

</div>
:::

::: section
### Explain Files - `explainFiles` {#explainFiles-config}
...
::: section
### Extended Diagnostics - `extendedDiagnostics` {#extendedDiagnostics-config}
...
-   Related:
    -   [`diagnostics`](#diagnostics){aria-label="Jump to compiler option info for diagnostics"}

</div>
:::

::: section
### Generate CPU Profile - `generateCpuProfile` {#generateCpuProfile-config}
...
::: section
### List Emitted Files - `listEmittedFiles` {#listEmittedFiles-config}
...
::: section
### List Files - `listFiles` {#listFiles-config}
...
-   Related:
    -   [`explainFiles`](#explainFiles){aria-label="Jump to compiler option info for explainFiles"}

</div>
:::

::: section
### Trace Resolution - `traceResolution` {#traceResolution-config}
...
handbook](module-resolution#tracing-module-resolution).
...
::: section
### Composite - `composite` {#composite-config}
...
handbook](project-references).

</div>

-   Related:
    -   [`incremental`](#incremental){aria-label="Jump to compiler option info for incremental"}

    -   [`tsBuildInfoFile`](#tsBuildInfoFile){aria-label="Jump to compiler option info for tsBuildInfoFile"}

-   Released:

    [3.0](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-3-0.html){aria-label="Release notes for TypeScript 3.0"}

</div>
:::

::: section
### Disable Referenced Project Load - `disableReferencedProjectLoad` {#disableReferencedProjectLoad-config}
...
::: section
### Disable Solution Searching - `disableSolutionSearching` {#disableSolutionSearching-config}
...
projects](project-references), this option provides a way
...
::: section
### Disable Source Project Reference Redirect - `disableSourceOfProjectReferenceRedirect` {#disableSourceOfProjectReferenceRedirect-config}
...
::: section
### Incremental - `incremental` {#incremental-config}
...
-   Related:
    -   [`composite`](#composite){aria-label="Jump to compiler option info for composite"}

    -   [`tsBuildInfoFile`](#tsBuildInfoFile){aria-label="Jump to compiler option info for tsBuildInfoFile"}

-   Released:

    [3.4](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-3-4.html){aria-label="Release notes for TypeScript 3.4"}

</div>
:::

::: section
### TS Build Info File - `tsBuildInfoFile` {#tsBuildInfoFile-config}
...
composite projects [in the handbook](project-references).

By default it is in the same folder as your emitted JavaScript and has a
`.tsbuildinfo` file extension. The default file name is based on the
`outFile` option or your tsconfig file name.
...
::: section
### No Error Truncation - `noErrorTruncation` {#noErrorTruncation-config}
...
::: section
### Preserve Watch Output - `preserveWatchOutput` {#preserveWatchOutput-config}
...
::: section
### Skip Default Lib Check - `skipDefaultLibCheck` {#skipDefaultLibCheck-config}
...
::: section
### Skip Lib Check - `skipLibCheck` {#skipLibCheck-config}
...
::: section
### Assume Changes Only Affect Direct Dependencies - `assumeChangesOnlyAffectDirectDependencies` {#assumeChangesOnlyAffectDirectDependencies-config}
...
## Watch Options {#watch-options style="position:relative;"}
...
Watch](configuring-watch).

<div>

::: section
### Watch File - `watchFile` {#watch-watchFile-config}
...
::: section
### Watch Directory - `watchDirectory` {#watch-watchDirectory-config}
...
::: section
### Fallback Polling - `fallbackPolling` {#watch-fallbackPolling-config}
...
::: section
### Synchronous Watch Directory - `synchronousWatchDirectory` {#watch-synchronousWatchDirectory-config}
...
::: section
### Exclude Directories - `excludeDirectories` {#watch-excludeDirectories-config}
...
::: section
### Exclude Files - `excludeFiles` {#watch-excludeFiles-config}
...
## Type Acquisition {#type-acquisition style="position:relative;"}
...
::: section
### Enable - `enable` {#type-enable-config}
...
::: section
### Include - `include` {#type-include-config}
...
::: section
### Exclude - `exclude` {#type-exclude-config}
...
::: section
### Disable Filename Based Type Acquisition - `disableFilenameBasedTypeAcquisition` {#type-disableFilenameBasedTypeAcquisition-config}
...
[https://www.typescriptlang.org/tsconfig](https://www.typescriptlang.org/tsconfig){._attribution-link}
:::
