...
Users with enough experience might not be surprised, but not everyone
...
## Equality narrowing {#equality-narrowing style="position:relative;"}
...
`padLeft` returns from within its first `if` block. TypeScript was able
