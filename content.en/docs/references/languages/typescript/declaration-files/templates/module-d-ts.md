...
### Default Exports {#default-exports style="position:relative;"}
...
See [Module: Functions](module-function-d-ts) for details of how that
...
To understand how namespaces work in `.d.ts` files read the [`.d.ts`
deep dive](../deep-dive).
