...
> Note:
>
> This page assumes you’re using [Jest](https://jestjs.io/) as a test runner. If you use a different test runner, you may need to adjust the API, but the overall shape of the solution will likely be the same. Read more details on setting up a testing environment on the Testing Environments page.
...
* [Setup/Teardown](testing-recipes.md#setup-teardown)
* [`act()`](testing-recipes.md#act)
* [Rendering](testing-recipes.md#rendering)
* [Data Fetching](testing-recipes.md#data-fetching)
* [Mocking Modules](testing-recipes.md#mocking-modules)
* [Events](testing-recipes.md#events)
* [Timers](testing-recipes.md#timers)
* [Snapshot Testing](testing-recipes.md#snapshot-testing)
* [Multiple Renderers](testing-recipes.md#multiple-renderers)
* [Something Missing?](testing-recipes.md#something-missing)
...
It’s typically better to make more specific assertions than to use snapshots. These kinds of tests include implementation details so they break easily, and teams can get desensitized to snapshot breakages. Selectively [mocking some child components](https://github.com/mindulle/Documents/blob/main/Languages/react/frequently-used/testing/broken-reference/README.md) can help reduce the size of snapshots and keep them readable for the code review.
