...
### Start with the mockup <a href="#start-with-the-mockup" id="start-with-the-mockup"></a>
...
### Step 1: Break the UI into a component hierarchy <a href="#step-1-break-the-ui-into-a-component-hierarchy" id="step-1-break-the-ui-into-a-component-hierarchy"></a>
...
### Step 2: Build a static version in React <a href="#step-2-build-a-static-version-in-react" id="step-2-build-a-static-version-in-react"></a>
...
### Step 3: Find the minimal but complete representation of UI state <a href="#step-3-find-the-minimal-but-complete-representation-of-ui-state" id="step-3-find-the-minimal-but-complete-representation-of-ui-state"></a>
...
<summary><strong>Deep DiveProps vs State</strong></summary>
...
### Step 4: Identify where your state should live <a href="#step-4-identify-where-your-state-should-live" id="step-4-identify-where-your-state-should-live"></a>
...
### Step 5: Add inverse data flow <a href="#step-5-add-inverse-data-flow" id="step-5-add-inverse-data-flow"></a>
