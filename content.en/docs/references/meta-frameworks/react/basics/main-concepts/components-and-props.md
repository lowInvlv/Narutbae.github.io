...
Whether you declare a component [as a function or a class](https://github.com/mindulle/Documents/blob/main/Languages/react/basics/main-concepts/broken-reference/README.md), it must never modify its own props. Consider this `sum` function:
