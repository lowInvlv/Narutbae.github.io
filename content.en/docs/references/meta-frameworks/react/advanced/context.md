...
* [When to Use Context](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
* [Before You Use Context](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
* [API](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
  * [React.createContext](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
  * [Context.Provider](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
  * [Class.contextType](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
  * [Context.Consumer](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
  * [Context.displayName](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
* [Examples](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
  * [Dynamic Context](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
  * [Updating Context from a Nested Component](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
  * [Consuming Multiple Contexts](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
* [Caveats](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
* [Legacy API](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
...
All consumers that are descendants of a Provider will re-render whenever the Provider’s `value` prop changes. The propagation from Provider to its descendant consumers (including [`.contextType`](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md) and `useContext`) is not subject to the `shouldComponentUpdate` method, so the consumer is updated even when an ancestor component skips an update.
...
> Note
>
> The way changes are determined can cause some issues when passing objects as `value`: see [Caveats](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md).
...
The `contextType` property on a class can be assigned a Context object created by [`React.createContext()`](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md). Using this property lets you consume the nearest current value of that Context type using `this.context`. You can reference this in any of the lifecycle methods including the render function.

> Note:
>
> You can only subscribe to a single context using this API. If you need to read more than one see [Consuming Multiple Contexts](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md).
>
