...
Since ES2022 you can also declare `defaultProps` as static property within a React component class. For more information, see the [class public static fields](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Classes/Public\_class\_fields#public\_static\_fields). This modern syntax will require a compilation step to work within older browsers.
