...
* [Identifying components with unsafe lifecycles](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
* [Warning about legacy string ref API usage](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
* [Warning about deprecated findDOMNode usage](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
* [Detecting unexpected side effects](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
* [Detecting legacy context API](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
* [Ensuring reusable state](https://github.com/mindulle/Documents/blob/main/Languages/react/advanced/broken-reference/README.md)
...
> Note:
>
> In CSS, the [`display: contents`](https://developer.mozilla.org/en-US/docs/Web/CSS/display#display\_contents) attribute can be used if you don’t want the node to be part of the layout.
...
At first glance, this code might not seem problematic. But if `SharedApplicationState.recordEvent` is not [idempotent](https://en.wikipedia.org/wiki/Idempotence#Computer\_science\_meaning), then instantiating this component multiple times could lead to invalid application state. This sort of subtle bug might not manifest during development, or it might do so inconsistently and so be overlooked.
